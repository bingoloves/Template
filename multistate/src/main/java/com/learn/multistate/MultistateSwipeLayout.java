...
/**
 * 公共组件：滑动刷新/加载数据的Layout
 */
public class MultistateSwipeLayout extends SwipeRefreshLayout implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public MultistateSwipeLayout(Context context) {
        this(context, null);
    }

    public MultistateSwipeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public MultistateSwipeLayout setOnReloadListener(OnReloadListener onReloadListener) {
        this.onReloadListener = onReloadListener;
        return this;
    }

    public MultistateSwipeLayout setEmptyText(@NonNull String text) {
        emptyTv.setText(text);
        return this;
    }

    public MultistateSwipeLayout setErrorText(@NonNull String text) {
        errorTv.setText(text);
        return this;
    }

    public MultistateSwipeLayout setNoNetWorkText(@NonNull String text) {
        noNetworkTv.setText(text);
        return this;
    }

    public MultistateSwipeLayout setEmptyImage(@DrawableRes int resId) {
        emptyImg.setImageResource(resId);
        return this;
    }

    public MultistateSwipeLayout setErrorImage(@DrawableRes int resId) {
        errorImg.setImageResource(resId);
        return this;
    }

    public MultistateSwipeLayout setNoNetWorkImage(@DrawableRes int resId) {
        noNetworkImg.setImageResource(resId);
        return this;
    }

    public MultistateSwipeLayout setEmptyImageVisible(boolean visible) {
        if (visible) {
    ...
    public MultistateSwipeLayout setErrorImageVisible(boolean visible) {
        if (visible) {
    ...
    public MultistateSwipeLayout setNoNetWorkImageVisible(boolean visible) {
        if (visible) {
    ...
    public MultistateSwipeLayout setReloadBtnText(@NonNull String text) {
    ...
    public MultistateSwipeLayout setReloadBtnTextSize(int sp) {
    ...
    public MultistateSwipeLayout setReloadBtnTextColor(@ColorRes int colorId) {
    ...
    public MultistateSwipeLayout setReloadBtnBackgroundResource(@DrawableRes int drawableId) {
        if (drawableId != NO_ID) {
    ...
    public MultistateSwipeLayout setReloadBtnVisible(boolean visible) {
        if (visible) {
    ...
    public MultistateSwipeLayout setReloadClickArea(@Area int area) {
        switch (area) {
            case FULL:
    ...
    public MultistateSwipeLayout setAllPageBackgroundColor(@ColorRes int colorId) {
    ...
    public MultistateSwipeLayout setAllTipTextColor(@ColorRes int colorId) {
    ...
    public MultistateSwipeLayout setAllTipTextSize(int sp) {
