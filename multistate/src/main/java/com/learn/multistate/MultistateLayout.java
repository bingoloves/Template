 ...
 * 多状态组件：加载数据Layout
 */
public class MultistateLayout extends FrameLayout implements View.OnClickListener {
    ...
    public MultistateLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        builder.setLoadingText(TextUtils.isEmpty(typedArray.getString(R.styleable.MultistateLayout_loadingText)) ? builder.loadingText : typedArray.getString(R.styleable.MultistateLayout_loadingText));
        builder.setLoadingTextColor(typedArray.getResourceId(R.styleable.MultistateLayout_loadingTextColor, builder.loadingTextColor));
        builder.setLoadingTextSize(typedArray.getInteger(R.styleable.MultistateLayout_loadingTextSize, builder.loadingTextSize));
        builder.setLoadingViewLayoutId(typedArray.getResourceId(R.styleable.MultistateLayout_loadingViewLayoutId, builder.loadingViewLayoutId));

        builder.setEmptyText(TextUtils.isEmpty(typedArray.getString(R.styleable.MultistateLayout_emptyText)) ? builder.emptyText : typedArray.getString(R.styleable.MultistateLayout_emptyText));
        builder.setEmptyImgId(typedArray.getResourceId(R.styleable.MultistateLayout_emptyImgId, builder.emptyImgId));
        builder.setEmptyImageVisible(typedArray.getBoolean(R.styleable.MultistateLayout_emptyImageVisible, builder.emptyImageVisible));

        builder.setErrorText(TextUtils.isEmpty(typedArray.getString(R.styleable.MultistateLayout_errorText)) ? builder.errorText : typedArray.getString(R.styleable.MultistateLayout_errorText));
        builder.setErrorImgId(typedArray.getResourceId(R.styleable.MultistateLayout_errorImgId, builder.errorImgId));
        builder.setErrorImageVisible(typedArray.getBoolean(R.styleable.MultistateLayout_errorImageVisible, builder.errorImageVisible));

        builder.setNoNetWorkText(TextUtils.isEmpty(typedArray.getString(R.styleable.MultistateLayout_noNetWorkText)) ? builder.noNetWorkText : typedArray.getString(R.styleable.MultistateLayout_noNetWorkText));
        builder.setNoNetWorkImgId(typedArray.getResourceId(R.styleable.MultistateLayout_noNetWorkImgId, builder.noNetWorkImgId));
        builder.setNoNetWorkImageVisible(typedArray.getBoolean(R.styleable.MultistateLayout_noNetWorkImageVisible, builder.noNetWorkImageVisible));

        builder.setAllPageBackgroundColor(typedArray.getResourceId(R.styleable.MultistateLayout_allPageBackgroundColor, builder.allPageBackgroundColor));
        builder.setAllTipTextSize(typedArray.getInteger(R.styleable.MultistateLayout_allTipTextSize, builder.allTipTextSize));
        builder.setAllTipTextColor(typedArray.getResourceId(R.styleable.MultistateLayout_allTipTextColor, builder.allTipTextColor));

        builder.setReloadBtnText(TextUtils.isEmpty(typedArray.getString(R.styleable.MultistateLayout_reloadBtnText)) ? builder.reloadBtnText : typedArray.getString(R.styleable.MultistateLayout_reloadBtnText));
        builder.setReloadBtnTextSize(typedArray.getInteger(R.styleable.MultistateLayout_reloadBtnTextSize, builder.reloadBtnTextSize));
        builder.setReloadBtnTextColor(typedArray.getResourceId(R.styleable.MultistateLayout_reloadBtnTextColor, builder.reloadBtnTextColor));
        builder.setReloadBtnBackgroundResource(typedArray.getResourceId(R.styleable.MultistateLayout_reloadBtnBackgroundResource, builder.reloadBtnBackgroundResource));
        builder.setReloadBtnVisible(typedArray.getBoolean(R.styleable.MultistateLayout_reloadBtnVisible, builder.reloadBtnVisible));
        builder.setReloadClickAreaType(typedArray.getInt(R.styleable.MultistateLayout_reloadClickArea, builder.reloadClickArea));
    ...
    public MultistateLayout setOnReloadListener(OnReloadListener onReloadListener) {
        this.onReloadListener = onReloadListener;
        return this;
    }

    public MultistateLayout setEmptyText(@NonNull String text) {
        emptyTv.setText(text);
        return this;
    }

    public MultistateLayout setErrorText(@NonNull String text) {
        errorTv.setText(text);
        return this;
    }

    public MultistateLayout setNoNetWorkText(@NonNull String text) {
        noNetworkTv.setText(text);
        return this;
    }

    public MultistateLayout setLoadingText(@NonNull String text) {
        if (loadingTv != null) {
    ...
    public MultistateLayout setLoadingTextSize(int sp) {
        if (loadingTv != null) {
            loadingTv.setTextSize(TypedValue.COMPLEX_UNIT_SP,sp);
        }
        return this;
    }

    public MultistateLayout setLoadingTextColor(@ColorRes int colorId) {
        if (loadingTv != null) {
    ...
    public MultistateLayout setEmptyImage(@DrawableRes int resId) {
        emptyImg.setImageResource(resId);
        return this;
    }

    public MultistateLayout setErrorImage(@DrawableRes int resId) {
        errorImg.setImageResource(resId);
        return this;
    }

    public MultistateLayout setNoNetWorkImage(@DrawableRes int resId) {
        noNetworkImg.setImageResource(resId);
        return this;
    }

    public MultistateLayout setEmptyImageVisible(boolean visible) {
        if (visible) {
    ...
    public MultistateLayout setErrorImageVisible(boolean visible) {
        if (visible) {
    ...
    public MultistateLayout setNoNetWorkImageVisible(boolean visible) {
        if (visible) {
    ...
    public MultistateLayout setReloadBtnText(@NonNull String text) {
    ...
    public MultistateLayout setReloadBtnTextSize(int sp) {
        emptyReloadBtn.setTextSize(TypedValue.COMPLEX_UNIT_SP,sp);
        errorReloadBtn.setTextSize(TypedValue.COMPLEX_UNIT_SP,sp);
        noNetWorkReloadBtn.setTextSize(TypedValue.COMPLEX_UNIT_SP,sp);
        return this;
    }

    public MultistateLayout setReloadBtnTextColor(@ColorRes int colorId) {
    ...
    public MultistateLayout setReloadBtnBackgroundResource(@DrawableRes int drawableId) {
        if (drawableId != NO_ID) {
    ...
    public MultistateLayout setReloadBtnVisible(boolean visible) {
        if (visible) {
    ...
    public MultistateLayout setReloadClickArea(@Area int area) {
        switch (area) {
            case FULL:
    ...
    public MultistateLayout setAllPageBackgroundColor(@ColorRes int colorId) {
    ...
    public MultistateLayout setAllTipTextColor(@ColorRes int colorId) {
    ...
    public MultistateLayout setAllTipTextSize(int sp) {
        emptyTv.setTextSize(TypedValue.COMPLEX_UNIT_SP,sp);
        errorTv.setTextSize(TypedValue.COMPLEX_UNIT_SP,sp);
        noNetworkTv.setTextSize(TypedValue.COMPLEX_UNIT_SP,sp);
        return this;
    }

    public MultistateLayout setLoadingViewLayoutId(@LayoutRes int layoutId) {
