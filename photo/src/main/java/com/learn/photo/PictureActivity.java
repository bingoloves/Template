...
import com.learn.photo.photo.ProgressView;
import com.learn.photo.photo.TransitionImageView;
import com.learn.photo.photo.photoview.PhotoView;
...
public class PictureActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private TextView indicatorTv;//数字指示器
    private int index = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        indicatorTv.setText((1+index)+"/"+data.size());
    ...
    public void onPageSelected(int i) {
        indicatorTv.setText((i+1)+"/"+data.size());
    }
