package com.learn.picker.widget;
...
import com.learn.picker.R;
import com.learn.picker.dataset.PickerDataSet;
...
public class PickerView<T> extends BasePickerView<T> {
  ...
  public void setTextSize(int minText, int maxText) {
    mOutTextSize = Util.sp2px(getContext(), minText);
    mCenterTextSize = Util.sp2px(getContext(), maxText);
    invalidate();
  }
